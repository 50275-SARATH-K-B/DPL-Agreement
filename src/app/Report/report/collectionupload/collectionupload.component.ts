...
@Component({
  selector: 'app-collectionupload',
  templateUrl: './collectionupload.component.html',
  styleUrls: ['./collectionupload.component.scss']
})
...
myInputVariable: ElementRef;
  ...
  displayedColumns: string[] = ["SlNo", "LoanNumber", "Date", "Amount", "PaymentMode","remarks"];
  ...
  ngOnInit() {
    ...
    exportexcel(id): void {
      ...
      /* save to file */
      XLSX.writeFile(wb, 'Bulk_upload' + new Date().toLocaleDateString() + ".xlsx");
    ...
    if(extension == 'xlsx'){
      ...
      fileReader.onload = (e) => {
        ...
        //  element.EligibilityupdatedDate instanceof Date
          ...
          let phObj = {
            "customerID":  element.LoanNumber.toString(),
            "customerName": "",
            "csmName": "",
            "empCode": "",
            "eligibilityAmount":+element.Amount.toString(),
            "recorD_NUMBER": i++,
            "interestRate": 0,
            "customerCategory": element.PaymentMode.toString(),
            "bureauScore": 0,
            "currentEMI": 0,
            "eligibilityupdatedDate": this._rptdatePipe(element.Date),
            "estimatedIncome": 0,
            "tenure": 0,
            "customerprofile": element.Remarks.toString(),
            "teamleader":"",
            "proccessingfee":0,
            "beauroname":""
          }
