...
myInputVariable: ElementRef;
  ...
  displayedColumns: string[] = ["SlNo", "CustomerID", "CustomerName", "EligibilityAmount", "InterestRate", "CustomerCategory","teamleader","proccessingfee","beauroname"];
      ...
      fileReader.onload = (e) => {
        ...
        //  element.EligibilityupdatedDate instanceof Date
          ...
          let phObj = {
            ...
            "customerCategory": element['SCHEME'].toString(),
            ...
            "teamleader":element.TEAMLEADER.toString(),
            "proccessingfee":element.PROCESSINGFEE.toString(),
            "beauroname":element.BUREAUNAME.toString()
          }
