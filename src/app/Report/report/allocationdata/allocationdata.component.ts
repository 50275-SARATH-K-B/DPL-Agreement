...
@Component({
  selector: 'app-allocationdata',
  templateUrl: './allocationdata.component.html',
  styleUrls: ['./allocationdata.component.scss']
})
export class AllocationdataComponent implements OnInit {
...
myInputVariable: ElementRef;
  ...
  ngOnInit() {
    ...
    exportexcel(id): void {
      ...
      /* save to file */
      XLSX.writeFile(wb, 'DATA_ALLOCATION' + new Date().toLocaleDateString() + ".xlsx");
        ...
        //  element.EligibilityupdatedDate instanceof Date
         var date = new Date()
          ...
          let phObj = {
            ...
            "customerName": "CustomerAllocation",
            "csmName": "",
            "empCode": "",
            "eligibilityAmount":0,
            "recorD_NUMBER": i++,
