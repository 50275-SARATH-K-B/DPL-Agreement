...
@Component({
  selector: 'app-csedata',
  templateUrl: './csedata.component.html',
  styleUrls: ['./csedata.component.scss']
})
export class CsedataComponent implements OnInit {
...
myInputVariable: ElementRef;
  ...
  displayedColumns: string[] = ["SlNo", "CSENAME", "EMPCODE", "STATE", "LANGUAGE"];
  ...
  ngOnInit() {
    ...
    exportexcel(id): void {
      ...
      /* save to file */
      XLSX.writeFile(wb, 'CSE_DATA' + new Date().toLocaleDateString() + ".xlsx");
      ...
      fileReader.onload = (e) => {
        ...
        //  element.EligibilityupdatedDate instanceof Date
         var date = new Date()
          let phObj = {
            "customerID": "" ,
            "customerName": "csedata",
            "csmName": element.CSENAME.toString(),
            "empCode": element.EMPCODE.toString(),
            "eligibilityAmount":0,
            "recorD_NUMBER": i++,
            "interestRate": 0,
            "customerCategory": element.STATE.toString(),
            "bureauScore": 0,
            "currentEMI": 0,
            "eligibilityupdatedDate": this._rptdatePipe(date),
            "estimatedIncome": 0,
            "tenure": 0,
            "customerprofile": element.LANGUAGE.toString(),
            "teamleader":"",
            "proccessingfee":0,
            "beauroname":""
          }
