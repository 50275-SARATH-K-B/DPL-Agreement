...
@Component({
  ...
  styleUrls: ['./insurance-upload.component.scss']
})
export class InsuranceUploadComponent implements OnInit {
  ...
  myInputVariable: ElementRef;
    ...
    displayedColumns: string[] = ["SlNo","LOAN_ID", "LOANID", "POLICY", "DATE"];
    ...
    ngOnInit() {
      ...
      exportexcel(id): void {
        ...
        /* save to file */
        XLSX.writeFile(wb, 'Insurance_upload' + new Date().toLocaleDateString() + ".xlsx");
          ...
          //  element.EligibilityupdatedDate instanceof Date
           var date = new Date()
            ...
            let phObj = {
              ...
              "csmName": "",
              "empCode": element.LOAN_ID.toString(),
              "eligibilityAmount":0,
              "recorD_NUMBER": i++,
              "interestRate": 0,
              "customerCategory": "insuranceupload",
              "bureauScore": 0,
              "currentEMI": 0,
              "eligibilityupdatedDate": this._rptdatePipe(this.trandformDate(element.UPLOAD_DATE)),
              "estimatedIncome": 0,
              "tenure": 0,
              "customerprofile": element.POLICY_NUMBER.toString(),
              "teamleader":"",
              "proccessingfee":0,
              "beauroname":""
            }
