...
@Component({
  selector: 'app-fileviewview',
  templateUrl: './fileviewview.component.html',
  styleUrls: ['./fileviewview.component.scss']
})
export class FileviewviewComponent implements OnInit {
  ...
  IsImagepdf: boolean;
  datavalue: any;
  constructor(private dialogs:MatDialogRef<FileviewviewComponent>,@Inject(MAT_DIALOG_DATA) public data: any) { }
  ngOnInit() {
