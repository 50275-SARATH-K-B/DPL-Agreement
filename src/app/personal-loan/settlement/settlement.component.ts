      ...
      .subscribe(res => {
        ...
        if (!!res && res['paymentModeList'] !== null) {
          if(!!sessionStorage['branchuser']){
            ...
            let dd = []
           if(!!res['paymentModeList'].find(s=>s.PaymentMode == "CASH")){
            dd.push(res['paymentModeList'].find(s=>s.PaymentMode == "CASH"))

           }else if(!!res['paymentModeList'].find(s=>s.PaymentMode == "Refund")){
            dd.push(res['paymentModeList'].find(s=>s.PaymentMode == "Refund"))

           }else if(!!res['paymentModeList'].find(s=>s.PaymentMode == "Waiver")){
