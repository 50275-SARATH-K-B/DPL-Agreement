...
@Component({
  selector: 'app-salesemp-upload',
  templateUrl: './salesemp-upload.component.html',
  styleUrls: ['./salesemp-upload.component.scss']
})
export class SalesempUploadComponent implements OnInit {
  ...
  myInputVariable: ElementRef;
    ...
    displayedColumns: string[] = ["SlNo", "loanid", "customerid", "csename","empcode"];
    ...
    ngOnInit() {
      ...
      exportexcel(id): void {
        ...
        /* save to file */
        XLSX.writeFile(wb, 'Sales_Employeedata' + new Date().toLocaleDateString() + ".xlsx");
        ...
        fileReader.onload = (e) => {
          ...
          //  element.EligibilityupdatedDate instanceof Date
           var date = new Date()
            ...
            let phObj = {
              "customerID": element.CUSTOMER_ID.toString() ,
              "customerName":"",
              "csmName":element.CSE_NAME.toString(),
              "empCode": element.EMP_CODE.toString(),
              "eligibilityAmount":element.LOAN_ID.toString(),
              "recorD_NUMBER": i++,
              "interestRate": 0,
              "customerCategory": "salesemployeeUp",
              "bureauScore": 0,
              "currentEMI": 0,
              "eligibilityupdatedDate": this._rptdatePipe(date),
              "estimatedIncome": 0,
              "tenure": 0,
              "customerprofile": "",
              "teamleader":"",
