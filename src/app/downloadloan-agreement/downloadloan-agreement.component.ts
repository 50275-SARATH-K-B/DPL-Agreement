...
@Component({
  selector: 'app-downloadloan-agreement',
  templateUrl: './downloadloan-agreement.component.html',
  styleUrls: ['./downloadloan-agreement.component.scss']
})
export class DownloadloanAgreementComponent implements OnInit { 
 settings: Settings;
  userData: any;
  todaydt: any;
  custdtls: any;
